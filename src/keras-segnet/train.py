...
def trainModel(X,Y,model,nb_epoch, validation_split = 0.2, batch_size = 1, save_path=""):
    ...
    save_model = ModelCheckpoint(save_path + "weights.{epoch:02d}-{val_loss:.2f}.hdf5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1)
...
nb_classes = 2
nb_epoch = 5 # number of round of traing
